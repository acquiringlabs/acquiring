# Generated by Django 4.2 on 2024-06-12 13:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('confirmable', models.BooleanField(editable=False, help_text='Whether this PaymentMethod can at some point run inside PaymentMethodSaga.confirm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='operation_events', to='acquiring.paymentmethod')),
            ],
        ),
        migrations.CreateModel(
            name='Milestone',
